 ...
 */
var throttleFn = function (fn, delay, type) {
...
export { _Calc, _CopyText, _CreateUUID as _CreatUUID, debounceFn as _DebounceFn, _DownBlobFile, _Extend, _FillZero, _FormatBlobUrl, _FormatDate, _FormatJsonSearch, _FormatMoneyNumCapital, _FormatMoneySymbol, _FormatSearchJson, _GetCookie, _GetIdCardBrithDay, _GetIdCardSex, _GetLocalStorage, _GetSessionStorage, getUaInfo as _GetUaInfo, getVarType as _GetVarType, isEmail as _IsEmail, _IsEmpty, _IsIdCard, isMoney as _IsMoney, isName as _IsName, isPhone as _IsPhone, isTel as _IsTel, _LimitInt, _LimitIntFloat, _LimitMoney, _LimitPNInt, _LimitPNIntFloat, _LoactionReplace, _LoadScript, _LoadScriptAwait, _SetCookie, _SetLocalStorage, _SetSessionStorage, throttleFn as _ThrottleFn, _ToAsyncAwait, index as default };
