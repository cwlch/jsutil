...
var gjUtils = /*#__PURE__*/Object.freeze({
    ...
    _SetSessionStorage: setSessionStorage,
    _SetLocalStorage: setLocalStorage,
    _GetCookie: getCookie,
    _GetSessionStorage: getSessionStorage,
    _GetLocalStorage: getLocalStorage,
    _GetVarType: getVarType,
    _GetUaInfo: getUaInfo,
    _GetIdCardSex: getIdCardSex,
    _GetIdCardBrithDay: getIdCardBirthDay,
    _FormatDate: formatDate,
    _FormatMoneySymbol: formatMoneySymbol,
    _FormatMoneyNumCapital: toCapitalMoney,
    _FormatBlobUrl: blobToURL,
    _FormatJsonSearch: toJsonSearch,
    _FormatSearchJson: toSearchJson,
    _LimitInt: limitInt,
    _LimitIntFloat: limitIntFloat,
    _LimitPNInt: limitPNInt,
    _LimitPNIntFloat: limitPNIntFloat,
    _LoadScript: loadScripts,
    _LoadScriptAwait: loadScriptsAwait,
    _CreatUUID: createUUID,
    _Extend: extend,
    _FillZero: fillZero,
    _DownBlobFile: downBlobFile,
    _LoactionReplace: locationReplace,
    _CopyText: copyText,
    _ToAsyncAwait: toAsyncAwait
});
...
export { copyText as _CopyText, createUUID as _CreatUUID, downBlobFile as _DownBlobFile, extend as _Extend, fillZero as _FillZero, blobToURL as _FormatBlobUrl, formatDate as _FormatDate, toJsonSearch as _FormatJsonSearch, toCapitalMoney as _FormatMoneyNumCapital, formatMoneySymbol as _FormatMoneySymbol, toSearchJson as _FormatSearchJson, getCookie as _GetCookie, getIdCardBirthDay as _GetIdCardBrithDay, getIdCardSex as _GetIdCardSex, getLocalStorage as _GetLocalStorage, getSessionStorage as _GetSessionStorage, getUaInfo as _GetUaInfo, getVarType as _GetVarType, isEmail as _IsEmail, isEmpty as _IsEmpty, isIdCard as _IsIdCard, isMoney as _IsMoney, isName as _IsName, isPhone as _IsPhone, isTel as _IsTel, limitInt as _LimitInt, limitIntFloat as _LimitIntFloat, limitPNInt as _LimitPNInt, limitPNIntFloat as _LimitPNIntFloat, locationReplace as _LoactionReplace, loadScripts as _LoadScript, loadScriptsAwait as _LoadScriptAwait, setCookie as _SetCookie, setLocalStorage as _SetLocalStorage, setSessionStorage as _SetSessionStorage, toAsyncAwait as _ToAsyncAwait, index as default };
