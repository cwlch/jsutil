 ...
 * @returns string
 */
var _GetVarType = (function (o) {
    var typeStr = (Object.prototype.toString.call(o).match(/\[object (.*?)\]/) || [])[1];
    if (typeStr === 'Object') {
        var constName = o.constructor.name;
        constName !== 'Object' && (typeStr = "".concat(typeStr, ":").concat(constName));
    }
 ...
 * @Description: file content
 */
var _FormatJsonSearch = function (myJson, prefix) {
    ...
    return "".concat(prefix).concat(arr.join('&'));
};
 ...
 * @Description: file content
 */
var formatUnitTime = function (formatStr, unit, timeNum) {
    return formatStr.replace(unit, (unit.length > 1 ? _FillZero(timeNum) : timeNum));
};
var _FormatNumTime = function (secondNum, format, fill) {
    var _a, _b, _c, _d, _e, _f;
    if (format === void 0) { format = 'dd天hh时ii分ss秒'; }
    if (fill === void 0) { fill = true; }
    var result = {};
    if (_GetVarType(Number(secondNum)) !== 'Number') {
        throw new Error('第一个参数为需要计算的秒数');
    }
    var unitDay = (_a = format.match(/(d+)/i)) === null || _a === void 0 ? void 0 : _a[0];
    var unitHours = (_b = format.match(/(h+)/i)) === null || _b === void 0 ? void 0 : _b[0];
    var unitMinute = (_c = format.match(/(i+)/i)) === null || _c === void 0 ? void 0 : _c[0];
    var unitSecond = (_d = format.match(/(s+)/i)) === null || _d === void 0 ? void 0 : _d[0];
    var formatTimeStr = format;
    // 根据格式判断，计算所需时间单位及其值
    if (unitDay) {
...
var Countdown = /** @class */ (function () {
    ...
    Countdown.prototype._calcSecond = function () {
        var _this = this;
        this.secondNum--;
        var formatRes = _FormatNumTime(this.secondNum, this.options.format, this.options.fill);
        ...
        if (this.secondNum < 1) {
            ...
            // 大于1继续计算
            this.stopCalc = setTimeout(function () { _this._calcSecond(); }, 1000);
        }
    };
    /**
     * @Description: 开始
...
var _CreateCountdown = function (_a) {
    var endTime = _a.endTime, _b = _a.format, format = _b === void 0 ? FORMAT_STR : _b, _c = _a.fill, fill = _c === void 0 ? true : _c, callback = _a.callback, finishCallback = _a.finishCallback, _d = _a.start, start = _d === void 0 ? true : _d;
 ...
 * @LastEditors: ch
 * @LastEditTime: 2022-10-16 21:16:53
 * @Description: file content
 */

export default jsutil;
export { _Calc, _CopyText, _CreateUUID as _CreatUUID, _CreateCountdown, _Debounce, _DownBlobFile, _Extend, _FillZero, _FormatBlobUrl, _FormatDate, _FormatJsonSearch, _FormatMoneyNumCapital, _FormatMoneySymbol, _FormatNumTime, _FormatSearchJson, _GetCookie, _GetIdCardBrithDay, _GetIdCardSex, _GetLocalStorage, _GetSessionStorage, getUaInfo as _GetUaInfo, _GetVarType, isEmail as _IsEmail, _IsEmpty, _IsIdCard, isMoney as _IsMoney, isName as _IsName, isPhone as _IsPhone, isTel as _IsTel, _LimitInt, _LimitIntFloat, _LimitMoney, _LimitPNInt, _LimitPNIntFloat, _LoactionReplace, _LoadScript, _LoadScriptAwait, _SetCookie, _SetLocalStorage, _SetSessionStorage, _Throttle, _ToAsyncAwait };
