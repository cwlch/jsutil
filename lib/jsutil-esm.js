...
class Dicts {
    constructor(params) {
        ...
        for (let key in params) {
            ...
            else if (['String', 'Number', 'Boolean'].includes(itemType)) {
...
_d = objectSymbol, _e = arraySymbol, _f = exampleSymbol;
let d = new Dicts({
