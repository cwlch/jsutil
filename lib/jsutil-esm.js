        ...
        for (let key in params) {
            ...
            if (itemType === 'Array') {
                ...
                if (itemTowType === 'Object') {
                    resultObj = Object.assign(Object.assign({}, resultObj), itemTwo);
                }
                else {
                    ...
                    if (itemThree) {
                        resultObj = Object.assign(Object.assign({}, resultObj), itemThree);
                    }
                }
            }
                ...
                resultObj = Object.assign(Object.assign({}, resultObj), item);
            }
            else {
                throw new Error('成员只支持Array,Object类型');
            }
            this[objectSymbol][key] = this[exampleSymbol][key] = resultObj;
            this[exampleSymbol][resultObj.value] = resultObj;
...
_a = objectSymbol, _b = arraySymbol, _c = exampleSymbol;
const _CreateDicts = (par) => new Dicts(par);
