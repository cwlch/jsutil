(function (global, factory) {
     ...
     * @Last Modified by: ch
     * @Last Modified time: 2020-12-02 14:43:59
     *
     */
    /**
     * 二进制文件流转换成可访问的URL
    ...
    var MyObjectURL = /** @class */ (function () {
        ...
        MyObjectURL.prototype.clear = function () {
            var MyURL = window.URL || window.webkitURL;
            MyURL.createObjectURL(this.url);
        };
        return MyObjectURL;
    }());
    ...
    */
    ...
    var downBlobFile = function (blob, fileName, suffix) {
        var $a = document.createElement('a'), urlObject = blobToURL(blob);
        // blob.name = undefined
     ...
     * @Last Modified by: ch
     * @Last Modified time: 2020-12-02 09:43:10
     */
    var index = {
        // 验证是否为空
        isEmpty: isEmpty,
