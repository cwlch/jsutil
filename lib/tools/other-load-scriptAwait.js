 ...
 */
var other_load_script_1 = __importDefault(require("./other-load-script"));
...
var loadScriptsAwait = function (scripts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                scriptArr = get_varType_1.default(scripts) === "string" ? [scripts] : scripts;
                return [4 /*yield*/, other_load_script_1.default(scriptArr[0])];
            case 1:
                res = _a.sent();
                i = 1, item = void 0;
                _a.label = 2;
            case 2:
                ...
                item = scriptArr[i];
                return [4 /*yield*/, other_load_script_1.default(item)];
            case 3:
                res = _a.sent();
                _a.label = 4;
            case 4:
...
exports.default = loadScriptsAwait;
